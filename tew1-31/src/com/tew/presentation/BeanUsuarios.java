...
public class BeanUsuarios extends Usuarios implements  Serializable {
	...
	public String peticion(Usuarios u) {
		...
		try {
			...
			service= Factories.services.createUsuariosService();
			Seguidores nuevoSeguidor = new Seguidores();
			
			nuevoSeguidor.setEmail_usuario(login.getEmail());
			nuevoSeguidor.setEmail_seguidor(u.getEmail());
			nuevoSeguidor.setAceptada(false);
			service.guardarSeguidor(nuevoSeguidor);
			filtrar();
			return "exito73";
	...
	public String baja(Usuarios u) {
        ...
        UsuariosService service;
        FotoService service2;
        SeguidoresService service3;
        try {
            ...
            if(sesion(u)) {
            		...
            		System.out.println("No se puede eliminar a un usuario que esté en sesión.");
            ...
            service = Factories.services.createUsuariosService();
            service2 = Factories.services.createFotoService();
            service3 = Factories.services.createSeguidoresService();
	...
	public String reset() {
		...
		try {
			...
			while(itr.hasNext()){
			 ...
			 System.out.println("Reiniciada base de datos");
